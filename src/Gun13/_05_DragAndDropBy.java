...
public class _05_DragAndDropBy extends BaseStaticDriver {
    public static void main(String[] args) {
        ...
        Action aksiyon2=aksiyonlar.dragAndDropBy(sagSurgu,200,0).build(); aksiyon.perform();

        double cubukGenislik=surguCubugu.getSize().width;
        System.out.println("cubukGenislik = " + cubukGenislik);

        double surguOrani=500/cubukGenislik; // her bir dolar için kaç birim surgu gidiyor. 500 dolar için 502
